...
(function loadJsInElectron(){
  if (Ardublockly.isRunningElectron()) {
	...
	//**********************************************************************
	//Modified by RLQ BlockWiSARD  Ardublockly -> DB4K - > BlockWiSARD
    window.$ = window.jQuery = require(projectRoot +
        '/BlockWiSARD/js_libs/jquery-2.1.3.min.js');
    window.Hammer = require(projectRoot + '/BlockWiSARD/js_libs/hammer.min.js');
    window.JsDiff = require(projectRoot + '/BlockWiSARD/js_libs/diff.js');
	//-----------------------------------------------------------------------
  }
})();
