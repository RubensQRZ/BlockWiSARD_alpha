...
class ServerTestCase(unittest.TestCase):
    ...
    def test_static_ardublockly(self):
        ...
        self.helper_test_static_file('BlockWiSARD', 'index.html')
	#----------------------------------------------------
    ...
    def test_index_redirect(self):
		...
		#****************************************************
		#---Modified by RLQ BlockWiSARD - changeg Ardublockly -> BlockWiSARD
        ardublockly_folder = os.path.join(self.temp_folder, 'BlockWiSARD')
        #-----------------------------------------------------
        ...
        self.assertEqual(response.url,
                         '%s/BlockWiSARD/index.html' % self.SERVER_URL)
		#-------------------------------------------------------				 
    ...
    def test_ardublockly_redirect(self):
        ...
        os.makedirs(ardublockly_folder)
        open(os.path.join(ardublockly_folder, 'index.html'), 'w').close()
        response = requests.get(self.SERVER_URL + '/BlockWiSARD')
        self.assertTrue(response.ok)
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response.url,
                         '%s/BlockWiSARD/index.html' % self.SERVER_URL)
