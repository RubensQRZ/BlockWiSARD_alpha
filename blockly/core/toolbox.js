...
Blockly.Toolbox.prototype.init = function() {
  ...
  // *******************************************************************
  // BlockWiSARD (Comentada a chamada da funçao   changeMenuItensColor(); 
...
/* Modified By RLQ-BlockWiSARD  - This function changes menu intens colors  */

function changeMenuItensColor(){

		//Captura os elementos de tela cujos atributos serão alterados
		
		var menuWiSARD=document.getElementById(":2");
		var textomenuWiSARD = document.getElementById(":2.label");
		var menuControle=document.getElementById(":4");
		var textomenuControle = document.getElementById(":4.label");
		var menuCondicionantes=document.getElementById(":6"); 
		var textomenuCondicionantes= document.getElementById(":6.label");
		var menuSensores=document.getElementById(":8"); 
		var textomenuSensores = document.getElementById(":8.label"); 
		var menuLED=document.getElementById(":a"); 
		var textomenuLED = document.getElementById(":a.label"); 
	    var menuMotores=document.getElementById(":c"); 
		var textomenuMotores = document.getElementById(":c.label"); 
		var menuDisplay=document.getElementById(":e"); 
		var textomenuDisplay = document.getElementById(":e.label"); 
		var menuSom=document.getElementById(":g"); 
		var textomenuSom = document.getElementById(":g.label"); 	
		var menuRobo=document.getElementById(":i"); 
		var textomenuRobo = document.getElementById(":i.label"); 
		...
		//Controla as cores do item Robo 
		textomenuRobo.style.color="white";
		menuRobo.style.backgroundColor="#6600CC";
		menuRobo.onmouseover=function(){menuRobo.style.backgroundColor="#3E017B"};
		menuRobo.onmouseout=function(){menuRobo.style.backgroundColor="#6600CC"};
	    //Controla as cores do item WiSARD 
		textomenuWiSARD.style.color="white";
		menuWiSARD.style.backgroundColor="#e00000"; //  #CCAA00
		menuWiSARD.onmouseover=function(){menuWiSARD.style.backgroundColor= " #a30b0b"};//#AE9203
		menuWiSARD.onmouseout=function(){menuWiSARD.style.backgroundColor="#e00000"}; // #CCAA00
	    //Controla as cores do item Sensores 
		textomenuSensores.style.color="white";
		menuSensores.style.backgroundColor="#88cb00";
		menuSensores.onmouseover=function(){menuSensores.style.backgroundColor="#6F8E12"};
		menuSensores.onmouseout=function(){menuSensores.style.backgroundColor="#88cb00"};
	    //Controla as cores do item Condicionantes 
		textomenuCondicionantes.style.color="white";
		menuCondicionantes.style.backgroundColor="#BECC00";
		menuCondicionantes.onmouseover=function(){menuCondicionantes.style.backgroundColor="#7B9E14"};
		menuCondicionantes.onmouseout=function(){menuCondicionantes.style.backgroundColor="#BECC00"};	
